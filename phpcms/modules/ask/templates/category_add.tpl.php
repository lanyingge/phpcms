...
<form name="myform" id="myform" action="?m=ask&c=category&a=add&menuid=<?php echo $_GET['menuid'] ?>" method="post">
<div class="pad-10">
<div class="col-tab">
...
<table width="100%" class="table_form ">
	...
	<tr>
	  ...
	  <?php
		echo form::urlrule('ask','show',0,$setting['category_ruleid'],'name="show_php_ruleid"');
	?>
	</div>
	<div id="show_html_ruleid" style="display:<?php if(!$setting['content_ishtml']) echo 'none';?>">
	  <?php	
		echo form::urlrule('ask','show',1,$setting['category_ruleid'],'name="show_html_ruleid"');
	?>
	</div>
	</td>
    </tr>
