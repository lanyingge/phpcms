...
<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
      <h6 class="title"><?php echo L('message');?></h6>
          <ul>
            ...
            <?php if(module_exists('ask')) { ?>
<h6 class="title">问吧管理</h6>
            <ul>
				<li><a href="index.php?m=ask&c=index&a=question" target="_blank"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="15" height="16" /> 我要提问</a></li>
            	<li<?php if(ROUTE_A=="ask" && ROUTE_M=="ask" && ROUTE_C=="center" && $status=="-1") { ?> class="on"<?php } ?>><a href="index.php?m=ask&c=center&a=ask&status=-1"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="15" height="16" /> 全部提问</a></li>
                <li<?php if(ROUTE_A=="ask" && ROUTE_M=="ask" && ROUTE_C=="center" && $status=="3") { ?> class="on"<?php } ?>><a href="index.php?m=ask&c=center&a=ask&status=3"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="15" height="16" /> 待解决提问</a></li>
				<li<?php if(ROUTE_A=="ask" && ROUTE_M=="ask" && ROUTE_C=="center" && $status=="5") { ?> class="on"<?php } ?>><a href="index.php?m=ask&c=center&a=ask&status=5"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="15" height="16" /> 已解决提问</a></li>
				<li<?php if(ROUTE_A=="ask" && ROUTE_M=="ask" && ROUTE_C=="center" && $flag=="1") { ?> class="on"<?php } ?>><a href="index.php?m=ask&c=center&a=ask&flag=1"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="15" height="16" /> 投票中的提问</a></li>
				<li<?php if(ROUTE_A=="ask" && ROUTE_M=="ask" && ROUTE_C=="center" && $flag=="-1") { ?> class="on"<?php } ?>><a href="index.php?m=ask&c=center&a=ask&flag=-1"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="15" height="16" /> 过期提问</a></li>
				<li<?php if(ROUTE_A=="answer" && ROUTE_M=="ask" && ROUTE_C=="center") { ?> class="on"<?php } ?>><a href="index.php?m=ask&c=center&a=answer"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="15" height="16" /> 我的回答</a></li>
				<li<?php if(ROUTE_A=="credit" && ROUTE_M=="ask" && ROUTE_C=="center") { ?> class="on"<?php } ?>><a href="index.php?m=ask&c=center&a=credit"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="15" height="16" /> 查看积分</a></li>
				<li<?php if(ROUTE_A=="actor" && ROUTE_M=="ask" && ROUTE_C=="center") { ?> class="on"<?php } ?>><a href="index.php?m=ask&c=center&a=actor"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="15" height="16" /> 头衔管理</a></li>
      </ul>
      <?php } ?>
